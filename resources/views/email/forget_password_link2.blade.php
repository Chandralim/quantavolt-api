...
@component('mail::button', ['url' => ($url??config('app.url'))."/set_new_password?token=".$email_token."&code=".$code])
Set New Password
@endcomponent
...
Or copy this link:
<br>
{{($url??config('app.url'))."/setNewPassword?token=".$email_token."&code=".$code}}
<br>
